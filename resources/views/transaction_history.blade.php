...
@section('content')
    <main class="w-full max-w-screen-lg lg:mx-auto px-6 sm:px-8 py-6">
        ...
        {{-- TODO: If the Buy Transaction data is empty --}}
        ...
        {{-- TODO: If the Buy Transaction data is not empty --}}
            ...
            <div class="mt-4 w-full max-w-screen-lg mx-auto bg-white shadow overflow-hidden sm:rounded-md">
                <ul class="divide-y divide-gray-200">
                    {{-- TODO: Show list of Buy Transaction History (accepted bid placed by the user) --}}
