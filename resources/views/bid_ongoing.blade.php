    ...
    <main class="w-full max-w-screen-lg lg:mx-auto px-6 lg:px-0 py-6">
        <nav
            ...
            <div class="flex space-x-2 flex-1 w-full sm:w-min">
                ...
                {{-- TODO: Redirect to Bid History Page --}}
                <a href=""
        ...
        {{-- TODO: If there is no ongoing bid yet --}}
        ...
        {{-- TODO: If there is at least one ongoing bid --}}
                        ...
                        <li class="block hover:bg-gray-50">
                            <div class="px-4 py-4 sm:px-6">
                                ...
                                <div class="mt-2 flex justify-between items-start relative">
                                    ...
                                    {{-- TODO: Provide Cancel Bid Action --}}
                                    <form class="absolute top-0 right-0" action="" method="POST">
                                        @csrf
